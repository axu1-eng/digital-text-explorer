...
cards:
  - label: 'Guide to Using the Ticha Document Explorer'
    eyebrow: 'Get Started'
  ...
  - label: 'Testament from San Jerónimo Tlacochahuaya, 1675'
    ...
    link: '/document/Tl675b'
  - label: 'Find Documents From My Town'
    eyebrow: 'Explore'
  ...
  <div class="lg:container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      ...
      <h3 class="text-xs text-red-700 tracking-widest font-medium title-font mb-1 uppercase">Home</h3>
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Chan <span class="text-red-700 font-extralight">la</span> Bienvenidos <span class="text-red-700  font-extralight">y</span>  Welcome</h1>
      ...
      <div class="xl:w-1/4 md:w-1/3 sm:w-1/2 p-4">
        <a href="{{ card.link }}">
          ...
          <div class="transition duration-250 ease-in-out hover:scale-105">
            ...
            <h2 class="text-2xl text-gray-900 font-medium title-font my-2 leading-tight">{{ card.label }}</h2>
