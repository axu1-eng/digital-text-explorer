...
const documentsCsv = path.join(root, 'src', '_data', 'csv', 'documents.csv');
const townsCsv = path.join(root, 'src', '_data', 'csv', 'towns.csv');
const outputDir = path.join(root, 'src', '_data', 'api');
